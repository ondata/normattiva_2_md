    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                ...
                <a href="https://github.com/aborruso/normattiva_2_md" target="_blank" class="bg-blue-500 bg-opacity-30 backdrop-blur-sm border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-opacity-40 transition">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6 hover-lift">
                ...
                <div class="text-sm text-gray-500">
                    <code class="bg-gray-100 px-2 py-1 rounded">-s "legge accessibilità"</code>
                </div>
            </div>
...
<section id="use-cases" class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Casi d'uso</h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                Scopri come normattiva2md può accelerare i tuoi progetti legali e AI
            </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div class="bg-white rounded-xl p-8 shadow-md">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-3">Legal Chatbot e RAG Systems</h3>
                <p class="text-gray-600 mb-4">
                    Costruisci chatbot legali alimentati da LLM con accesso diretto alle normative italiane. Sistemi RAG (Retrieval-Augmented Generation) per Q&A accurate su leggi e decreti.
                </p>
                <div class="bg-gray-50 rounded-lg p-4">
                    <code class="text-sm text-gray-700">
                        # Scarica e converti per RAG<br>
                        normattiva2md -s "GDPR" output.md<br>
                        # Usa in chatbot context
                    </code>
                </div>
                <a href="https://github.com/aborruso/normattiva_2_md#ricerca-in-linguaggio-naturale" target="_blank" class="inline-block mt-4 text-blue-600 hover:text-blue-700 font-medium">
            ...
            <div class="bg-white rounded-xl p-8 shadow-md">
                <div class="text-4xl mb-4">✅</div>
                <h3 class="text-2xl font-bold text-gray-900 mb-3">Compliance Automation</h3>
                <p class="text-gray-600 mb-4">
                    Analisi automatica di conformità normativa per contratti, documenti aziendali e processi. Verifica compliance con AI e NLP.
                </p>
                <div class="bg-gray-50 rounded-lg p-4">
                    <code class="text-sm text-gray-700">
                        # Scarica normative rilevanti<br>
                        normattiva2md "URL_legge" legge.md<br>
                        # Analizza con LLM
                    </code>
                </div>
                <a href="https://github.com/aborruso/normattiva_2_md#uso" target="_blank" class="inline-block mt-4 text-blue-600 hover:text-blue-700 font-medium">
                    Vedi esempi →
                </a>
            </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-md">
                <div class="text-4xl mb-4">🔍</div>
                <h3 class="text-2xl font-bold text-gray-900 mb-3">Legal Research Database</h3>
                <p class="text-gray-600 mb-4">
                    Crea database interrogabile di leggi italiane. Indicizzazione semantica per ricerca full-text e analisi comparativa tra normative.
                </p>
                <div class="bg-gray-50 rounded-lg p-4">
                    <code class="text-sm text-gray-700">
                        # Download batch di leggi<br>
                        normattiva2md "URL" --with-references<br>
                        # Indicizza in database vettoriale
                    </code>
                </div>
                <a href="https://github.com/aborruso/normattiva_2_md/blob/main/docs/PRD.md" target="_blank" class="inline-block mt-4 text-blue-600 hover:text-blue-700 font-medium">
                    Roadmap →
                </a>
            </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-md">
                <div class="text-4xl mb-4">📚</div>
                <h3 class="text-2xl font-bold text-gray-900 mb-3">Document Publishing</h3>
                <p class="text-gray-600 mb-4">
                    Wiki legali, knowledge base e piattaforme di documentazione. Formato Markdown pronto per Jekyll, Hugo, MkDocs, Obsidian.
                </p>
                <div class="bg-gray-50 rounded-lg p-4">
                    <code class="text-sm text-gray-700">
                        # Converti per wiki<br>
                        normattiva2md input.xml wiki/legge.md<br>
                        # Publish su Jekyll/Hugo
                    </code>
                </div>
                <a href="https://github.com/aborruso/normattiva_2_md/tree/main/test_data" target="_blank" class="inline-block mt-4 text-blue-600 hover:text-blue-700 font-medium">
                    Vedi esempi →
                </a>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex border-b border-gray-300 mb-6">
                <button class="tab-button active px-6 py-3 font-medium text-gray-600" data-tab="tab-pip">
                    pip install
                </button>
                <button class="tab-button px-6 py-3 font-medium text-gray-600" data-tab="tab-uv">
                    uv tool
                </button>
                <button class="tab-button px-6 py-3 font-medium text-gray-600" data-tab="tab-source">
                    From Source
                </button>
            </div>

            <!-- Tab Content: pip -->
            <div id="tab-pip" class="tab-content active">
...
normattiva2md input.xml > output.md</code></pre>
            ...
            <!-- Tab Content: uv -->
            <div id="tab-uv" class="tab-content">
                <div class="bg-white rounded-lg shadow-lg p-8">
...
normattiva2md "URL" output.md --with-references</code></pre>
            ...
            <div class="mt-8 text-center">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="https://github.com/aborruso/normattiva_2_md/blob/main/README.md" target="_blank" class="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition">
                    ...
                    <a href="https://github.com/aborruso/normattiva_2_md/issues" target="_blank" class="inline-flex items-center gap-2 bg-gray-200 text-gray-800 px-6 py-3 rounded-lg hover:bg-gray-300 transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<section class="py-20 bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="https://github.com/aborruso/normattiva_2_md" target="_blank" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:bg-opacity-20 transition">
                View on GitHub
            </a>
        </div>
    </div>
